import { useReducer, useCallback, createElement } from 'react';
...
var useScreenReader = function useScreenReader() {
  var _React$useReducer = useReducer(elementReducer, initialState),
      _React$useReducer2 = _slicedToArray(_React$useReducer, 2),
      state = _React$useReducer2[0],
      dispatch = _React$useReducer2[1];

  var a11y = useCallback(function () {
    var message = Object.keys(state).find(function (x) {
      return state[x].focused;
    });
    return message ? createElement(AriaLiveMessage, {
      "aria-live": "polite"
    }, createElement("p", null, message)) : null;
  }, [state]);
  var createEventHandlers = useCallback(function (message) {
    return {
  ...
  var reader = useCallback(function (message) {
    if (!state[message]) {
